...
namespace Microsoft.CoreWf.Expressions
{
    public sealed class Multiply<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            {
                EnsureOperationFunction(metadata, ref s_checkedOperationFunction, ExpressionType.MultiplyChecked);
            }
            else
            {
                EnsureOperationFunction(metadata, ref s_uncheckedOperationFunction, ExpressionType.Multiply);
            }
        }
