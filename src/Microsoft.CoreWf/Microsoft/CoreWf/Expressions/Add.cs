...
namespace CoreWf.Expressions
{
    public sealed class Add<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            {
                EnsureOperationFunction(metadata, ref s_checkedOperationFunction, ExpressionType.AddChecked);
            }
            else
            {
                EnsureOperationFunction(metadata, ref s_uncheckedOperationFunction, ExpressionType.Add);
            }
        }
