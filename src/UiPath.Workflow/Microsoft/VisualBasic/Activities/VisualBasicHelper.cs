...
namespace Microsoft.VisualBasic.Activities
{
    ...
    class VisualBasicHelper : LanguageHelper
    {
        ...
        public LambdaExpression CompileNonGeneric(LocationReferenceEnvironment environment)
        {
            ...
            var scriptAndTypeScope = new VisualBasicScriptAndTypeScope(environment);
        ...
        class VisualBasicScriptAndTypeScope
        {
            ...
            public VisualBasicScriptAndTypeScope(LocationReferenceEnvironment environmentProvider)
            {
