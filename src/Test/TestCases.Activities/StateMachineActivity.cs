...
public class StateMachineActivity
{
    ...
    public void MultipleTransitions()
    {
        ...
        State initialState = new() { Entry = new WriteLine { Text = "initialState" }, 
            Transitions = { new() { Action = new WriteLine { Text = "t1" }, To = state1, Condition = true }, 
                                  new() { Action = new WriteLine { Text = "t2" }, To = state2, Condition = true } } };
