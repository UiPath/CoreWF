...
namespace LegacyTest.Test.Common.TestObjects.Tracking
{
    ...
    public static class TrackingConstants
    {
        ...
        public readonly static string RemoteInMemoryTrackingParticipantNs = typeof(LegacyTest.Test.Common.TestObjects.Tracking.RemoteInMemoryTrackingParticipant).AssemblyQualifiedName;
    }
}
