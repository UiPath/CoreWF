...
namespace LegacyTest.Cases.Flowchart
{
    public class Execution
    {
        ...
        public void PersistFlowchart()
        {
            ...
            LegacyTest.JsonFileInstanceStore.FileInstanceStore jsonStore = new LegacyTest.JsonFileInstanceStore.FileInstanceStore(".\\~");
        ...
        public void UnloadFlowchartWhileExecutingFlowConditionalCondition()
        {
            ...
            LegacyTest.JsonFileInstanceStore.FileInstanceStore jsonStore = new LegacyTest.JsonFileInstanceStore.FileInstanceStore(System.Environment.CurrentDirectory);
