...
namespace LegacyTest.Cases.Flowchart
{
    public class ObjectModel : IDisposable
    {
        ...
        {
            LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine writeLine1 = new LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine
            {
                Message = new InArgument<string>("Hello1")
            };
            LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine writeLine2 = new LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine
            {
                Message = new InArgument<string>("Hello2")
            };
            LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine writeLine3 = new LegacyTest.Test.Common.TestObjects.CustomActivities.WriteLine
            {
