...
namespace TestCases.Xaml.Common.InstanceCreator
{
    ...
    {
        static Dictionary<string, MethodInfo> Creators;
        static Type[] basicMethodParams = new Type[] { typeof(Random) };
        static Type primitiveCreatorType = typeof(PrimitiveCreator);
        static Regex elideTypeGenerics = new Regex("`.+$");

        static PrimitiveCreator()
        {
            //Type primitiveCreatorType = typeof(PrimitiveCreator);
            Creators = new Dictionary<string, MethodInfo>();
            Creators.AddCreatorMethod(typeof(Boolean))
                    .AddCreatorMethod(typeof(Byte))
                    .AddCreatorMethod(typeof(Char))
                    .AddCreatorMethod(typeof(DateTime))
                    .AddCreatorMethod(typeof(DateTimeOffset))
                    .AddCreatorMethod(typeof(DBNull))
                    .AddCreatorMethod(typeof(Decimal))
                    .AddCreatorMethod(typeof(Double))
                    .AddCreatorMethod(typeof(Guid))
                    .AddCreatorMethod(typeof(Int16))
                    .AddCreatorMethod(typeof(Int32))
                    .AddCreatorMethod(typeof(Int64))
                    .AddCreatorMethod(typeof(Object))
                    .AddCreatorMethod(typeof(SByte))
                    .AddCreatorMethod(typeof(Single))
                    .AddCreatorMethod(typeof(String))
                    .AddCreatorMethod(typeof(TimeSpan))
                    .AddCreatorMethod(typeof(UInt16))
                    .AddCreatorMethod(typeof(UInt32))
                    .AddCreatorMethod(typeof(UInt64))
                    .AddCreatorMethod(typeof(Uri))
                    .AddCreatorMethod(typeof(XmlQualifiedName))
                    .AddCreatorMethod(typeof(Stream))
                    .AddCreatorMethod(typeof(XmlElement))
                    .AddCreatorMethod(typeof(XmlNode[]))
                    .AddCreatorMethod(typeof(DataTable))
                    .AddCreatorMethod(typeof(DataSet))
                    .AddCreatorMethod(typeof(InArgument<>));
        }
        ...
        {
            if (rndGen.NextDouble() < 0.01) return null; // 1% chance of null value
