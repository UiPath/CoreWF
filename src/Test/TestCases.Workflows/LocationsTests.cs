...
namespace TestCases.Workflows
{
    public class LocationsTests
    {
        ...
        public void SimpleWorkflowWithArgsAndVar()
        {
            ...
            var locations = ScopeUtils.GetCompatibleLocations(writeLine2, typeof(string));
        ...
        public void NestedSequencesWithVars()
        {
            ...
            locations = ScopeUtils.GetCompatibleLocations(writeLine1, typeof(string));
        ...
        public void IfThenElseBranchWithVars()
        {
            ...
            var locations = ScopeUtils.GetCompatibleLocations(writeLine3, typeof(string));
            ...
            locations = ScopeUtils.GetCompatibleLocations(writeLine4, typeof(string));
