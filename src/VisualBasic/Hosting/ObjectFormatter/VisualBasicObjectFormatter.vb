...
Namespace Microsoft.CodeAnalysis.VisualBasic.Scripting.Hosting
    ...
    Public NotInheritable Class VisualBasicObjectFormatter
        ...
        Private Shared ReadOnly s_impl As New VisualBasicObjectFormatterImpl()
        ...
        Public Shared Function FormatTypeName(type As Type) As String
            Return s_impl.FormatType(type)
        End Function
    End Class
