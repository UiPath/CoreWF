...
namespace System.Activities.Transactions
{
    ...
    /// </summary>
    [Serializable]
    [System.Runtime.CompilerServices.TypeForwardedFrom("System.Activities.Transactions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089")]
    public class TransactionException : SystemException
    {
        ...
        internal static TransactionException Create(string message, Guid distributedTxId)
        {
            if (IncludeDistributedTxId(distributedTxId))
            {
                return new TransactionException(SR.DistributedTxIDInTransactionException(message, distributedTxId));
            }
    ...
    public class TransactionAbortedException : TransactionException
    {
        ...
        internal TransactionAbortedException(Exception innerException, Guid distributedTxId) :
            base(IncludeDistributedTxId(distributedTxId) ?
                SR.DistributedTxIDInTransactionException(SR.TransactionAborted, distributedTxId)
