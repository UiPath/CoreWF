...
{
    private static readonly IList<RuntimeDelegateArgument> _emptyDelegateParameters = new List<RuntimeDelegateArgument>(0);

    public ActivityAction() { }

    internal override IList<RuntimeDelegateArgument> InternalGetRuntimeDelegateArguments() => _emptyDelegateParameters;
}
