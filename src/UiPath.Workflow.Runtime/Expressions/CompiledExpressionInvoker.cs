...
{
    private static bool _disableLocationArgumentCreation = Environment.GetEnvironmentVariable("UIPATH_EXPRESSION_DISABLE_LOCATION_ARGUMENT") != null;
    ...
    private void ProcessLocationReferences()
    {
        ...
        foreach (LocationReferenceEnvironment environment in environments)
        {
            ...
            {
                if (!_disableLocationArgumentCreation)
