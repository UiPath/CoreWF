...
namespace CoreWf.Expressions
{
    ...
    public static class TextExpression
    {
        ...
        private static readonly ReadOnlyCollection<string> s_defaultNamespaces = new ReadOnlyCollection<string>(new string[]
        {
            "System",
            "System.Collections",
        ...
        public static IList<string> DefaultNamespaces
        {
            get
            {
                return TextExpression.s_defaultNamespaces;
            }
        }
        ...
        public static IList<AssemblyReference> DefaultReferences
        {
            get
            {
                return TextExpression.s_defaultReferences;
            }
        }
