...
internal partial class TD
{
    ...
    {
        get => EventSource.CurrentThreadActivityId;
        set => EventSource.SetCurrentThreadActivityId(value);
    }

    internal static bool IsEtwProviderEnabled => WfEventSource.Instance.IsEnabled();

    internal static void SetActivityId(Guid newId, out Guid oldId) => EventSource.SetCurrentThreadActivityId(newId, out oldId);
    ...
    internal static void TraceTransfer(Guid newId)
    {
        ...
        {
            Guid activityId = EventSource.CurrentThreadActivityId;
            if (newId != activityId)
            {
